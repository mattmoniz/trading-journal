...
export async function detectGlobexFlush(io) {
  try {
    ...
    // NOT scoped to CONTINUATION/REVERSAL mode -- isOppositeDirectionOpen() is roster-wide and
    // direction-only, it doesn't need or use a family/level string at all (DeepSeek review,
    // 2026-09-07, confirmed the mode-vs-family question is moot for the 2 gates this checkpoint
    // actually calls).
