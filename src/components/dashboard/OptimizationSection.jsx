...
export default function OptimizationSection({ optData, tradeLocData }) {
  ...
  return (
    <section id="section-optimization" className="behavior-section">
      <h2>Trade Optimization <span style={{ fontSize: 13, fontWeight: 400, color: 'var(--text-muted)' }}>— per individual trade, using 1-min bars</span></h2>
      ...
      <div className="backtest-summary-cards" style={{ marginBottom: 24 }}>
        {[
          ...
          <div key={c.label} className="backtest-summary-card">
            ...
            <div style={{ fontSize: 13, color: 'var(--text-muted)', marginTop: 2 }}>{c.sub}</div>
          </div>
        ))}
      </div>
      ...
      <h3 style={{ fontSize: 14, fontWeight: 600, marginBottom: 12, color: 'var(--text-secondary)' }}>Performance by Time of Day <span style={{ fontWeight: 400, fontSize: 13 }}>(entry hour, EST)</span></h3>
                  ...
                  <td style={{ padding: '10px 12px' }}>
                    {r.mfe_p75 != null
                      ? <span style={{ fontSize: 13 }}>
                          ...
                          <span style={{ color: 'var(--text-muted)', fontSize: 13, marginLeft: 4 }}>pts (p75 winners)</span>
                        </span>
