...
export const SETUP_DISPLAY_LABELS = {
  ...
  MAJOR_PIVOT_DEFENDED_BREAK_LONG:  'MAJOR_PIVOT_DEFENDED_BREAK_LONG',
  MAJOR_PIVOT_DEFENDED_BREAK_SHORT: 'MAJOR_PIVOT_DEFENDED_BREAK_SHORT',
  STALL_DEFENDED_LEVEL_LONG:  'STALL_DEFENDED_LEVEL_LONG',
  STALL_DEFENDED_LEVEL_SHORT: 'STALL_DEFENDED_LEVEL_SHORT',
