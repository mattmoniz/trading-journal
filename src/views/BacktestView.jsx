                ...
                <React.Fragment key={s.rawName + '-' + s.signalType}>
                  ...
                  {expandedRow === s.rawName && (() => {
                    const guides = {
                      ...
                      'OR5_MID': { what: '5-min OR midpoint. Tradeable as soon as the OR completes (no longer gated to IB close — see setup reference).', how: 'After 9:35, first touch of OR mid. 35pt stop, 20pt target. 5 trades/day possible.', best: 'Highest frequency scalp in the system.', avoid: 'Choppy days where OR mid is noise.', risk: 'Stop: 35pt ($71). 5 trades/day fits $400 DLL.' },
